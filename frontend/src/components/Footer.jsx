...
const Footer = () => {
  ...
  <img className="w-28 mt-1" src={assets.logo} alt="MediConnect Logo" />
  <p className="text-gray-600 leading-6 md:max-w-[75%]">
    <strong>MediConnect – Effortless Healthcare Scheduling
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2 text-gray-600">
            ...
            <li>customersupport@MediConnect.in</li>
          </ul>
        </div>
      </div>
      ...
      <p className="py-4 text-sm text-center text-gray-600">
        © 2025 MediConnect.in — All Rights Reserved.
      </p>
    </div>
  );
};
